...
## 应用场景：对话气泡显示、状态提示气泡、伤害/治疗数值显示、交互提示UI、其他浮动式UI反馈
## 功能特性：基于 [Tween] 的平滑动画、命名的组合UI管理、淡入淡出效果、可扩展的动画效果
## 架构设计：基于 [Dictionary] 的UI控件管理、使用 [StringName] 作为UI标识、提供多种动画效果接口
## [br][b]编辑者:[/b] Sora
@tool
class_name CBalloon
extends IComponent
