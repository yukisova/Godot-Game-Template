...
##
## 架构设计：
## - 基于 [StateMachineHfsm] 的根状态机管理
## - 通过 [StatePda] 实现状态栈功能
## - 与 [SGameState] 集成的暂停/继续机制
##
## [br][b]编辑者:[/b] Sora
@tool
class_name CState
