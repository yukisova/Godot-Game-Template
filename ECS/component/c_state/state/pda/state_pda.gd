...
## - 基于 [StringName] 的状态关键词识别
## - 通过 [Dictionary] 管理上下文数据
##
## [br][b]编辑者:[/b] Sora
@tool
...
## 状态关键词
## 
## 用于唯一标识PDA状态的字符串名称，类型为 [StringName]。
## TODO: 考虑使用UUID来提高唯一性保证
var keyword: StringName

## 归属状态
## 
## 指向管理此PDA状态的HFSM状态实例，类型为 [StateHfsm]。
var belong_state: StateHfsm

## 状态上下文
## 
## 存储状态执行所需的上下文信息，由HFSM状态提供和管理。类型为 [Dictionary]。
